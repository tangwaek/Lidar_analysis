...
lasfiles <- here() # this goes one step back in the file directory
#------------------------------------------------------------------------------
#++++++ test with a single las file  --------------------------

#C:\Users\ElvisTangwa\Documents\las_files

las <- readLAS(paste0(lasfiles,"/las_file/M-33-23-D-a-1-3-1-1.las"))
